    ...
    return (
        <section className="h-full mt-2 px-6 py-10 text-center font-sans relative">
            ...
            <div className="flex absolute flex-col inset-0 px-6 py-8 mt-2 overflow-auto sm:flex-row items-center">
                ...
                <div className="pl-6 pt-4 sm:w-3/5 flex-initial">
                    ...
                    <button className="rounded-full bg-hoverwhite text-bgyellow w-60 px-4 py-2 mt-6 font-bold text-xs md:float-left text-2xl"> <Link to="/adoptionlist"> ADOPTABLE CATS & KITTENS </Link> </button>
