...
function Adopt() {
    ...
    return (
        <section className="h-full mt-2 px-6 py-10 text-center font-sans relative">
            ...
            <div className="flex absolute flex-col inset-0 px-6 py-8 mt-2 overflow-auto sm:flex-row items-center">
                <div className="w-60 sm:w-8/12 flex-initial">
                    <img className="w-full h-full" src={require(`../../assets/img/adopt-pic.jpg`)} alt="adopt-pic" />
                </div>
                <div className="pt-4 sm:w-3/5 flex-initial sm:pl-6 lg:pl-6">
                    ...
                    <div className="">
                        <button className="rounded-full bg-hoverwhite text-bgyellow w-60 px-4 py-2 mt-6 font-bold text-xs md:float-left text-2xl mx-2 lg:mx-2"> <Link to="/adoptionlist"> ADOPTABLE CATS & KITTENS </Link> </button>
                        <button className="rounded-full bg-hoverwhite text-bgyellow w-60 px-4 py-2 mt-6 font-bold text-xs md:float-left text-2xl mx-2 lg:mx-2"> <Link to="/application"> START APPLICATION </Link> </button>
                    </div>
                </div>
            </div>
